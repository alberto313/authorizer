...
public class Account   {
  ...
  private AccountAccount account = null;

  public Account account(AccountAccount account) {
  ...
  **/
  ...
  public AccountAccount getAccount() {
    return account;
  }

  public void setAccount(AccountAccount account) {
    this.account = account;
  }
